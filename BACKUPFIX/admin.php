        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="laundry" placeholder="LAUNDRY" class="form-control"/>
                </div>

                <div class="form-group">
                    <label for="sisa_laundry">SISA LAUNDRY</label>
                    <input type="text" id="sisa_laundry" placeholder="SISA LAUNDRY" class="form-control"/>
                </div>

                <div class="form-group">
                    <label for="listrik">LISTRIK</label>
                    <input type="text" id="listrik" placeholder="LISTRIK" class="form-control"/>
                </div>

                <div class="form-group">
                    <label for="sisa_listrik">SISA LISTRIK</label>
                    <input type="text" id="sisa_listrik" placeholder="SISA LISTRIK" class="form-control"/>
                </div>

                <div class="form-group">
                    <label for="charge">CHARGE</label>
                    <input type="text" id="charge" placeholder="CHARGE" class="form-control"/>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="update_charge" placeholder="CHARGE" class="form-control"/>
                </div>
