...
if(isset($_POST))
{
    ...
    // Update User details
    $query = "UPDATE penghuni SET id = '$id', nama = '$nama', no_kamar = '$no_kamar',laundry = '$laundry',sisa_laundry = '$sisa_laundry',total_laundry = '$total_laundry',listrik = '$listrik',sisa_listrik = '$sisa_listrik',charge ='$charge' WHERE id = '$id'";
